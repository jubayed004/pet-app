...
class SubscriptionPlanViewTwo extends StatefulWidget {
  ...
  const SubscriptionPlanViewTwo({super.key,
    required this.planName,
    required this.price,
    required this.color,
    required this.containerColor, required this.features,
    required this.id
  });

  @override
  State<SubscriptionPlanViewTwo> createState() =>
      _SubscriptionPlanViewTwoState();
}

class _SubscriptionPlanViewTwoState extends State<SubscriptionPlanViewTwo> {
  final subscriptionController =
  GetControllers.instance.getSubscriptionController();
