              ...
              children: [
                ...
                CustomTextField(
                  ...
                  validator: (value) {
                    ...
                    if (!nameOk) return "Use letters, spaces, and . ' - only";
                    return null;
                  },
                ),
                ...
                CustomButton(
                  ...
                  if(formKey.currentState!.validate()){
                    businessAllPetController.addHealth(body : body, id: id, status: businessAllPetController.statusValue.value);
                  }
                  },
                  title: "Submit",
...
Future<void> editAddHealthDialog(BuildContext context, String date,String title, String name, String id) {
  final businessAllPetController = GetControllers.instance.getBusinessAllPetController();
