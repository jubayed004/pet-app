...
class _BusinessPetsDetailsScreenState extends State<BusinessPetsDetailsScreen> with AutomaticKeepAliveClientMixin {
          ...
          child: NestedScrollView(
            headerSliverBuilder:
                (context, innerScrolled) => [
                  ...
                  Obx(() {
                    return CustomDefaultAppbar(title: businessAllPetController.details.value.pet?.name ?? "");
                  }),
                  ...
                  SliverToBoxAdapter(
                    child: Obx(() {
                      ...
                      return image.isNotEmpty
                          ? Image.network(ApiUrl.imageBase + image, height: MediaQuery.of(context).size.height / 7)
                          : Image.network(
                                ...
                                children: [
                                  Obx(() {
                                    ...
                                    return Column(
                                      ...
                                      children: [
                                        CustomText(text: pet?.name ?? "", textAlign: TextAlign.start, fontWeight: FontWeight.w600, fontSize: 16),
                                        const Gap(6),
                                        CustomText(
                                          text: pet?.gender ?? "",
                          ...
                          Row(
                            children: [
                              ...
                              Obx(() {
                                ...
                                return CustomText(text: "About $name", fontWeight: FontWeight.w600, fontSize: 16);
                              }),
                            ],
                          ),
                          const Gap(16),
                            ...
                            children: [
                              ...
                              GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(color: const Color(0xFFE54D4D), borderRadius: BorderRadius.circular(10)),
                                  child: const Row(
                                    children: [
                  ...
                  SliverPersistentHeader(
                    ...
                    delegate: _TabBarHeaderDelegate(
                      TabBar(
                        ...
                        tabs: const [Tab(text: 'Past vaccinations'), Tab(text: 'Next vaccinations')],
                      ),
                    ),
                  ),
                ],
...
class _TabBarHeaderDelegate extends SliverPersistentHeaderDelegate {
  ...
  Widget build(BuildContext context, double shrinkOffset, bool overlapsContent) {
    return Material(color: Colors.white, elevation: overlapsContent ? 2 : 0, child: _tabBar);
  }
