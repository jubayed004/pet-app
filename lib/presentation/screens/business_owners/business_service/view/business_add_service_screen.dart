...
class BusinessAddServiceScreen extends StatefulWidget {
  ...
  @override
  State<BusinessAddServiceScreen> createState() =>
      _BusinessAddServiceScreenState();
}
class _BusinessAddServiceScreenState extends State<BusinessAddServiceScreen> {
  final businessAddServiceController = GetControllers.instance
      .getBusinessAddServiceController();
  ...
  final ValueNotifier<
      List<TextEditingController>> serviceController = ValueNotifier(
  ...
  void _addBeltField() {
    ...
    [...serviceController.value, TextEditingController()];
  }
                ...
                children: [
                  ...
                  GestureDetector(
                    ...
                    child: SizedBox(
                      ...
                      child: Obx(() {
                        final image = businessAddServiceController.selectedImage
                            .value?.path;
                        return Stack(
                          children: [
                            Positioned.fill(
                          ...
                          return Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                const Gap(5),
                                index == 0
                                    ? IconButton(onPressed: _addBeltField,
                  ...
                  CustomTextField(
                    ...
                    validator: (value) {
                      final v = value?.trim() ?? '';
                      if (v.isEmpty) return 'Enter your location';
                      if (v.length < 3) {
                  ...
                  Obx(() {
                    return GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Text(
                          businessAddServiceController.openingTime.value == null ? "Select opening time" : businessAddServiceController.openingTime.value!.format(context),
                          style: TextStyle(
                            fontSize: 16,
                            color: businessAddServiceController.openingTime.value == null ? Colors.grey : Colors.black,
                          ),
                        ),
                      ),
                    );
                    ...
                    return GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Text(
                          ...
                          style: TextStyle(
                            fontSize: 16,
                            color: businessAddServiceController.closingTime
                  ...
                  Obx(() {
                    final value = businessAddServiceController.selectedWeek
                        .value;
