...
class _BusinessAddServiceScreenState extends State<BusinessAddServiceScreen> {
  ...
  final ValueNotifier<List<TextEditingController>> serviceController = ValueNotifier([TextEditingController()]);
                            ...
                            Expanded(
                                child: CustomTextField(
                                  ...
                                  validator: (value) {
                                    ...
                                    // Optional: require at least one letter or number (not just symbols/spaces)
                                    final hasAlnum = RegExp(r'[A-Za-z0-9]').hasMatch(v);
                                    if (!hasAlnum) return 'Enter a meaningful service name';
                ...
                Obx(() {
                  return GestureDetector(
                    ...
                    child: Container(
                      ...
                      padding: const EdgeInsets.symmetric(horizontal: 12),
                      child: Text(
                        businessAddServiceController.closingTime.value == null ? "Select closing time" : businessAddServiceController.closingTime.value!.format(context),
                        style: TextStyle(
                          fontSize: 16,
