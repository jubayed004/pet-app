        ...
        child: SafeArea(
          child: CustomScrollView(
            ...
            slivers: [
              ...
              Obx(() {
                if (businessServiceController.loading.value == Status.loading) {
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const CustomText(
                            text:
                                "Start by tapping the + icon above to add your first service and let your customers find you easily.",
                            fontSize: 14,
