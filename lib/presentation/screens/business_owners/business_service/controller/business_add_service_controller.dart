...
class BusinessAddServiceController extends GetxController {
  ...
  final List<String> analystType = ["Vet", "Grooming", "Shop", "Hotel", "Training", "Friendly "];
  ...
  final List<String> weekly = ["Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"];
