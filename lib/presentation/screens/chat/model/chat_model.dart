...
class BlockStatus {
  ...
  BlockStatus({this.isBlockedByYou, this.isBlockedByPartner, this.isBlocked});
    ...
    messages:
        json["messages"] == null
            ...
            : List<MessageItem>.from(
              json["messages"]!.map((x) => MessageItem.fromJson(x)),
            ),
    blockedBy:
        json["blockedBy"] == null
            ? []
...
class Participant {
  ...
  Participant({this.id, this.name, this.role, this.profilePic});
